...
/**
 * Test case to check if user is able to slay a monster.
 */
public class ControllerKillMonsterTest {

  @Test
  public void testKillMonster() {
    StringReader input = new StringReader("m S m E m S s 2 N s 2 N q");
