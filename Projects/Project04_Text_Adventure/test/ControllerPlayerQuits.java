...
/**
 * Test case to check if user is able to quit the game when he chooses to do so.
 */
public class ControllerPlayerQuits {

  @Test
  public void testPlayerQuitsTheGame() {
    StringReader input = new StringReader("q m S");
    Appendable gameLog = new StringBuilder();
    IGame m = new Game(WrappingType.WRAPPING, 6, 6,
            13, 30, 40);
