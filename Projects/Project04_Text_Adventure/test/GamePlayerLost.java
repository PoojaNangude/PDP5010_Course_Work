...
public class GamePlayerLost {
  ...
  public void testPlayerLost() {
    ...
    assertEquals("ID(7) N(1NORTH 13SOUTH 8EAST 12WEST )"
            + "(1 13 8 12 ) (CA) (treasure: D R )  (Arrows: 2)",
            game.getPlayerPresentLocationDetails().toString());
    // player collects treasure
    game.collectTreasure();
    assertEquals("Location Id (7)Co-ordinates: (1,0)"
            + "Treasure collected(DIAMOND:1 RUBY:1 SAPPHIRE:0 )(smell: 2)(arrows: 3)",
            game.getPlayer().toString());
    ...
    assertEquals("Location Id (13)Co-ordinates: (2,0)Treasure collected"
            + "(DIAMOND:1 RUBY:1 SAPPHIRE:0 )(smell: 2)(arrows: 2)", game.getPlayer().toString());
     ...
     */
    game.movePlayerInGivenDirection(Directions.SOUTH);
    assertEquals("Location Id (19)Co-ordinates: (3,0)Treasure collected"
            + "(DIAMOND:1 RUBY:1 SAPPHIRE:0 )(smell: 1)(arrows: 2)", game.getPlayer().toString());
     ...
     */
    game.movePlayerInGivenDirection(Directions.SOUTH);
    assertEquals("Location Id (25)Co-ordinates: (4,0)Treasure collected"
            + "(DIAMOND:1 RUBY:1 SAPPHIRE:0 )(smell: 0)(arrows: 2)", game.getPlayer().toString());
    ...
    assertEquals("Location Id (14)Co-ordinates: (2,1)"
            + "Treasure collected(DIAMOND:1 RUBY:1 SAPPHIRE:0 )(smell: 2)(arrows: 2)",
            game.getPlayer().toString());
    // player smell senses (2 means more pungent smell detected by the player)
    assertEquals(2, game.getPlayer().getLevelOfPungentSmellDetected());
    // player shoots arrow
    ...
    assertEquals("Location Id (8)Co-ordinates: (1,1)"
            + "Treasure collected(DIAMOND:1 RUBY:1 SAPPHIRE:0 )(smell: 2)(arrows: 0)",
            game.getPlayer().toString());
    assertEquals("ID(8) N(2NORTH 14SOUTH 7WEST 9EAST )(2 14 7 9 ) "
            + "(CA) (treasure: D R ) (M 0 ) (Arrows: 2)",
            game.getPlayerPresentLocationDetails().toString());
    ...
    game.movePlayerInGivenDirection(Directions.WEST);
    game.movePlayerInGivenDirection(Directions.SOUTH);
    assertFalse(game.getPlayer().getIsAlive());
    assertTrue(game.getPlayerPresentLocationDetails()
            .getLocationId() == game.getEndPointLocationId());
    assertTrue(game.getPlayerPresentLocationDetails().getMonster().getHealth() == 2);
