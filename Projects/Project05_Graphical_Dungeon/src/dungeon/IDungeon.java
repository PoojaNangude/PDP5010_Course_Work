...
public interface IDungeon {
  ...
  /*
  Function to get the number of rows in the dungeon.
   */
  int getRows();

  /*
  Function to get the number of columns in the dungeon.
   */
  int getColumns();

  /*
  Function to get the dump of the dungeon which will be used to represent the view.
   */
